...
namespace MovieHub.Migrations
{
    ...
    [Migration("20220405065359_add_movieruntimeId_to_showtime")]
    partial class add_movieruntimeId_to_showtime
    {
            ...
            modelBuilder.Entity("MovieHub.Models.Survey", b =>
                {
                    ...
                    b.Property<string>("CinemaNumber")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<int>("Nuisance")
                        .HasColumnType("integer");

                    b.Property<int>("PopcornQuality")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MovieHub.Models.Showtime", b =>
                {
                    ...
                    b.HasOne("MovieHub.Models.MovieRuntime", "MovieRuntime")
                        .WithMany()
                        .HasForeignKey("MovieRuntimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
